...
import { TipoMuestra } from '../models/tipomuestra.model';
...
export class TipoMuestraService {
  ...
  constructor(
    ...
    private url: string = `${environment.UrlApi3}/tipomuestra`;
    ...
    Obtener(id: string){
      ...
      return this.http.get<TipoMuestra>(urls);
    }
    ...
    Guardar(id: string, model: TipoMuestra){
      if(id==""){
        let urls = `${this.url}`;
