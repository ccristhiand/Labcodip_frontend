...
import { faHouse,faChartSimple,faBarcode,faUserDoctor,faBuilding,faChartColumn,faFileExcel, faPlane,faGears,faHandshakeSimple,faShield,faUserNurse, faIdCard,
         faFlaskVial,faLaptopMedical,faLaptopCode,faDatabase,faHouseMedical,faHospital, faGear, faLayerGroup, faVial, faBiohazard,faFileZipper
...
@Component({
    ...
    >
        <!-- <fa-icokn [icon]="faChartColumn"  class="layout-menuitem-icon"></fa-icon> -->
        <fa-icon [icon]="this.getIcon(item.icon)" class="layout-menuitem-icon"></fa-icon>
   ...
   onSubmenuAnimated(event: AnimationEvent) {
    ...
    getIcon(iconName: string):any {
        switch (iconName) {
          ...
          case 'faBarcode': return  faBarcode;
          case 'faHouseMedical': return faHouseMedical;
          case 'faFlaskVial': return faFlaskVial;
          case 'faLayerGroup':return faLayerGroup;
          case 'faVial':return faVial;
          case 'faBiohazard':return faBiohazard
          case 'faFileZipper':return faFileZipper
          default: return null;
        }
      }
