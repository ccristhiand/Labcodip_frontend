...
export class AppLayoutComponent implements OnDestroy {
    ...
    constructor(private menuService: MenuService, public layoutService: LayoutService, public renderer: Renderer2, public router: Router, private _usuarioService:UsuarioService,) {
    ...
    hideMenu() {
        if(this.router.url=="/"){
            this._usuarioService.VerificarToken();
        }else{
